...
const ItemCard = ({ product }) => {
    const {  removeFromCart, clearCart } = useStore((state) => ({
    ...
    return (
        <div>
            <div className='w-full grid grid-cols-5 mb-4 border py-2'>
                ...
                <button className='py-2 px-10 bg-red-500 text-white font-semibold uppercase mb-4 hover:bg-red-700 duration-300 cursor-pointer '
                    onClick={clearCart} >
                    Reset Cart
                </button>
            </div>
